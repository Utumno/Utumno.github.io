...
- Basics:
	...
	- [*args and **kwargs][11] - pythonisms too
	- [Printing tuple with string formatting in Python][12]
	- [Python - print tuple elements with no brackets][13]
	`', ,'.join([str(i[0]) for i in mytuple])`
	- [Why calling file.read in python fills my file with garbage?][14]
	- [Yield][15]

argparse:

- [Python argparse command line flags without arguments][16]
...
[as](https://github.com/wrye-bash/wrye-bash/blob/aaa90f4f14f1879bb1c1bcb3c4e59bfe1424ea9f/Mopy/bash/balt.py#L912-L915)
 in the program I am maintaining.

#####Python launcher for windows

Double click on a script will open with specified (by shebang) python version.
Easiest to install: install python 3.3+ (see [this][17] for installer options).
[Gentle introduction][18] and the [PEP][19].
  ...
  [11]: http://stackoverflow.com/questions/3394835/args-and-kwargs
  [12]: http://stackoverflow.com/questions/1455602/printing-tuple-with-string-formatting-in-python
  [13]: http://stackoverflow.com/questions/19112735/python-print-tuple-elements-with-no-brackets#comment38914099_19112784
  [14]: http://stackoverflow.com/questions/24973284/why-calling-file-read-in-python-fills-my-file-with-garbage
  [15]: http://stackoverflow.com/questions/231767/what-does-the-yield-keyword-do-in-python
  [16]: http://stackoverflow.com/questions/8259001/python-argparse-command-line-flags-without-arguments
  [17]: http://stackoverflow.com/a/13297878/281545
  [18]: http://www.rmi.net/~lutz/py33-windows-launcher.html
  [19]: http://legacy.python.org/dev/peps/pep-0397/
